...
### Let's try mapping the feeding events onto the time series directly.
Hmm, but what does that even mean...
...
p <- ggplot()+
  geom_sf(data = bg)+
  coord_sf(xlim = range(testData$long, na.rm = TRUE), 
           ylim = range(testData$lat, na.rm = TRUE), 
           expand = FALSE)+
  # lines and points
