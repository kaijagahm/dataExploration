...
XXX next to do:
- use a smaller subset of the days (10 days? vs 60 that i have now) to test out benchmarking to get the code to run faster. 
- change network code so that it includes all possible vertices. This one's really important, since it has a big effect on things like density.
